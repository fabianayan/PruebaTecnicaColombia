...
public class DaoMarca {
  ...
  public DaoMarca() {
    ...
    public void updateMarca() throws SQLException, Exception{
        Conexion conn = new Conexion();
        conn.conectar();
        String stringUpdate = "update marca set descripcion= ";
        
        stringUpdate = stringUpdate + " '" + unaMarca.getDescripcion() + "'";
        stringUpdate = stringUpdate + " where codigo= " + unaMarca.getCodigo() ;
        
        
        PreparedStatement query =conn.coneccion.prepareStatement(stringUpdate);
    ...
    public void deleteMarca() throws SQLException, Exception{
        Conexion conn = new Conexion();
        conn.conectar();
        String stringDelete = "delete marca ";
        
        stringDelete = stringDelete + " where codigo= " + unaMarca.getCodigo() ;
        
        
        PreparedStatement query =conn.coneccion.prepareStatement(stringDelete);
